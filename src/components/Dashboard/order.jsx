...
function Sales ({ data }) {
  return (
    <div className={styles.sales}>
      <div className={styles.title}>结账单数</div>
      <ResponsiveContainer minHeight={200}>
        <LineChart data={data}>
          ...
          />
          <Line type="monotone" isAnimationActive={false} dataKey="单数" stroke={color.red} strokeWidth={3} dot={{ fill: color.red }} activeDot={{ r: 5, strokeWidth: 0 }} />
        </LineChart>
      </ResponsiveContainer>
    </div>
  )
