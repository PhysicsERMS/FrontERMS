...
function Sales ({ data }) {
  return (
    <div className={styles.sales}>
      <div className={styles.title}>客流</div>
      <ResponsiveContainer minHeight={200}>
        <LineChart data={data}>
          ...
          />
          <Line type="monotone" isAnimationActive={false} dataKey="客流" stroke={color.green} strokeWidth={3} dot={{ fill: color.green }} activeDot={{ r: 5, strokeWidth: 0 }} />
        </LineChart>
      </ResponsiveContainer>
    </div>
  )
